...
function THEME:Initialize()
	Clockwork.option:SetKey("icon_data_classes", {
		path = "",
		size = nil
	})

	Clockwork.option:SetKey("icon_data_settings", {
		path = "",
		size = nil
	})

	Clockwork.option:SetKey("icon_data_donations", {
		path = "",
		size = nil
	})

	Clockwork.option:SetKey("icon_data_system", {
		path = "",
		size = nil
	})

	Clockwork.option:SetKey("icon_data_scoreboard", {
		path = "",
		size = nil
	})

	Clockwork.option:SetKey("icon_data_inventory", {
		path = "",
		size = nil
	})

	Clockwork.option:SetKey("icon_data_directory", {
		path = "",
		size = nil
	})

	Clockwork.option:SetKey("icon_data_attributes", {
		path = "",
		size = nil
	})
	...
	MENU_ITEM_SLICED = Clockwork.render:AddSlice9("SimpleTint", "ug_clockwork/sliced/simpletint", 6)
	SLICED_SMALL_TINT = Clockwork.render:AddSlice9("SimpleTint", "ug_clockwork/sliced/simpletint", 6)
	SLICED_INFO_MENU_INSIDE = Clockwork.render:AddSlice9("SimpleTint", "ug_clockwork/sliced/simpletint", 6)
	PANEL_LIST_SLICED = Clockwork.render:AddSlice9("SimpleTint", "ug_clockwork/sliced/simpletint", 6)
	DERMA_SLICED_BG = Clockwork.render:AddSlice9("SimpleRed", "ug_clockwork/sliced/simplered", 28)
	SLICED_LARGE_DEFAULT = Clockwork.render:AddSlice9("SimpleRed", "ug_clockwork/sliced/simplered", 28)
	SLICED_PROGRESS_BAR = Clockwork.render:AddSlice9("SimpleRed", "ug_clockwork/sliced/simplered", 28)
	SLICED_PLAYER_INFO = Clockwork.render:AddSlice9("SimpleRed", "ug_clockwork/sliced/simplered", 28)
	SLICED_INFO_MENU_BG = Clockwork.render:AddSlice9("SimpleRed", "ug_clockwork/sliced/simplered", 28)
	SLICED_COLUMNSHEET_BUTTON = Clockwork.render:AddSlice9("SimpleTint", "ug_clockwork/sliced/simpletint", 6)
...
function THEME.hooks:PostCharacterMenuInit(panel)
end

-- Called every frame that the character menu is open.
function THEME.hooks:PostCharacterMenuThink(panel)
end

-- Called after the character menu is painted.
function THEME.hooks:PostCharacterMenuPaint(panel)
end

-- Called after a character menu panel is opened.
function THEME.hooks:PostCharacterMenuOpenPanel(panel)
end

-- Called after the main menu has initialized.
function THEME.hooks:PostMainMenuInit(panel)
end
...
function THEME.hooks:PostMainMenuOpenPanel(panel, panelToOpen)
end
...
function THEME.hooks:PostMainMenuThink(panel)
end
