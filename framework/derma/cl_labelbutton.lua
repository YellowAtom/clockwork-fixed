...
function PANEL:OnMouseReleased(code)
	...
	if code == MOUSE_LEFT and self.DoClick and not self:GetDisabled() then
		self.DoClick(self)
	end
end
...
function PANEL:Think()
	...
	local colorDisabled = Color(math.max(colorWhite.r - 50, 0), math.max(colorWhite.g - 50, 0), math.max(colorWhite.b - 50, 0), 255)
