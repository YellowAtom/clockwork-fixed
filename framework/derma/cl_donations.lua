...
function PANEL:Rebuild()
	...
	table.sort(donations, function(a, b) return a.expireTime < b.expireTime end)
...
function PANEL:Init()
	...
	if self.donationTable.expireTime > 0 and unixTime > self.donationTable.expireTime then
