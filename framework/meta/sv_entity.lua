...
function entityMeta:EmitHitSound(sound)
	self:EmitSound("weapons/crossbow/hitbod2.wav", math.random(100, 150), math.random(150, 170))
...
function entityMeta:IsBeingHeld()
	if IsValid(self) then return cwPlugin:Call("GetEntityBeingHeld", self) end
end
