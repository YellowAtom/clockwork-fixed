...
function ITEM:OnCreateShipmentEntity(player, batch, position)
	return Clockwork.entity:CreateGenerator(player, self("generatorInfo").uniqueID, position)
end
...
function ITEM:OnSetup()
	...
	if generatorInfo then
		Clockwork.generator:Register(generatorInfo.name, generatorInfo.power, generatorInfo.health, generatorInfo.maximum, generatorInfo.cash, generatorInfo.uniqueID, generatorInfo.powerName, generatorInfo.powerPlural)
	end
end
