...
Clockwork.animation.stored.combineOverwatch = {
	...
	["crouch_crossbow_aim_idle"] = ACT_RANGE_AIM_AR2_LOW,
	["crouch_crossbow_aim_walk"] = ACT_WALK_CROUCH_RIFLE,
	["stand_crossbow_aim_walk"] = ACT_WALK_AIM_RIFLE,
	["stand_crossbow_aim_idle"] = ACT_IDLE_ANGRY,
	["stand_crossbow_aim_run"] = ACT_RUN_AIM_RIFLE,
	["crouch_crossbow_idle"] = ACT_RANGE_AIM_AR2_LOW,
	["crouch_crossbow_walk"] = ACT_WALK_CROUCH_RIFLE,
	["stand_crossbow_walk"] = "WalkEasy_all",
	["stand_crossbow_idle"] = ACT_IDLE,
	["stand_crossbow_run"] = ACT_RUN_RIFLE,
	["crossbow_attack"] = ACT_GESTURE_RANGE_ATTACK_AR2,
	["crossbow_reload"] = ACT_GESTURE_RELOAD,
...
Clockwork.animation.stored.civilProtection = {
	...
	["crouch_crossbow_aim_walk"] = ACT_WALK_CROUCH,
	["crouch_crossbow_aim_idle"] = ACT_COVER_SMG1_LOW,
	["stand_crossbow_aim_idle"] = "SMGcover",
	["stand_crossbow_aim_walk"] = ACT_WALK_AIM_RIFLE,
	["stand_crossbow_aim_run"] = ACT_RUN_AIM_RIFLE,
	["crouch_crossbow_walk"] = ACT_WALK_CROUCH,
	["crouch_crossbow_idle"] = ACT_COVER_SMG1_LOW,
	["stand_crossbow_idle"] = ACT_IDLE_SMG1,
	["stand_crossbow_walk"] = ACT_WALK_RIFLE,
	["stand_crossbow_run"] = ACT_RUN_RIFLE,
	["crossbow_attack"] = ACT_GESTURE_RANGE_ATTACK_SMG1,
	["crossbow_reload"] = ACT_GESTURE_RELOAD_SMG1,
...
Clockwork.animation.stored.femaleHuman = {
	...
	["crouch_crossbow_idle"] = ACT_COVER_LOW_RPG,
	["crouch_crossbow_aim_idle"] = ACT_RANGE_AIM_SMG1_LOW,
	["crouch_crossbow_walk"] = ACT_WALK_CROUCH_RPG,
	["crouch_crossbow_aim_walk"] = ACT_WALK_CROUCH_AIM_RIFLE,
	["stand_crossbow_idle"] = ACT_IDLE_RPG_RELAXED,
	["stand_crossbow_aim_idle"] = ACT_IDLE_AIM_RIFLE_STIMULATED,
	["stand_crossbow_walk"] = ACT_WALK_RPG,
	["stand_crossbow_aim_walk"] = ACT_WALK_AIM_RIFLE_STIMULATED,
	["stand_crossbow_run"] = ACT_RUN_RPG,
	["stand_crossbow_aim_run"] = ACT_RUN_AIM_RIFLE_STIMULATED,
	["crossbow_attack"] = ACT_GESTURE_RANGE_ATTACK_SMG1,
	["crossbow_reload"] = ACT_GESTURE_RELOAD_SMG1,
...
Clockwork.animation.stored.maleHuman = {
	...
	["stand_crossbow_idle"] = ACT_IDLE_RPG_RELAXED,
	["stand_crossbow_aim_idle"] = ACT_IDLE_AIM_RIFLE_STIMULATED,
	["stand_crossbow_walk"] = ACT_WALK_RPG_RELAXED,
	["stand_crossbow_aim_walk"] = ACT_WALK_AIM_RIFLE_STIMULATED,
	["stand_crossbow_run"] = ACT_RUN_RPG_RELAXED,
	["stand_crossbow_aim_run"] = ACT_RUN_AIM_RIFLE_STIMULATED,
	["crossbow_attack"] = ACT_GESTURE_RANGE_ATTACK_SMG1,
	["crossbow_reload"] = ACT_GESTURE_RELOAD_SMG1,
