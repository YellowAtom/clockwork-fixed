...
Clockwork.animation.stored.combineOverwatch = {
	...
	["blunt_reload"] = ACT_MELEE_ATTACK1,
...
Clockwork.animation.stored.civilProtection = {
	...
	["blunt_attack"] = ACT_MELEE_ATTACK_SWING_GESTURE,
	["blunt_reload"] = ACT_MELEE_ATTACK_SWING_GESTURE,
...
Clockwork.animation.stored.femaleHuman = {
	...
	["stand_ar2_idle"] = ACT_IDLE_SHOTGUN_RELAXED,
	["stand_ar2_aim_idle"] = ACT_IDLE_ANGRY_SMG1,
	...
	["ar2_attack"] = ACT_GESTURE_RANGE_ATTACK_SHOTGUN,
	["ar2_reload"] = ACT_GESTURE_RELOAD_SMG1,
