local COMMAND = Clockwork.command:New("PlyWhitelistLimit");
COMMAND.tip = "Allows you to alter a player's character limit for a specific faction.";
	...
	if (target) then
		...
		if (factionTable) then
			...
			if (limit) then
				...
				Clockwork.player:NotifyAll(player:Name().." has adjusted "..target:Name().."'s '"..factionTable.name.."' character limit to "..limit..".");
			else
