...
ITEM.name = "Yellow UU Backpack";
ITEM.uniqueID = "yellowuubackpack";
ITEM.business = true;
ITEM.batch = 1;
...
ITEM.slot = "back";
ITEM.slotSpace = 6;
ITEM.description = "A rough looking discoloured yellow UU backpack with some strange patterns on it.";
