...
ITEM.cost = 66; -- Increase to whatever.
...
ITEM.key = t_cassette.Register("Isi's Intermission", { -- Name that the cassette UI will show.
        {
            name = "Plastic Love",
            length = 476, -- Length of song in seconds.
            url = "https://dl.dropboxusercontent.com/s/usfxzkj9hoqwpkr/Mariya%20Takeuchi%20Plastic%20Love%20%E7%AB%B9%E5%86%85%20%E3%81%BE%E3%82%8A%E3%82%84.mp3?dl=0" -- Upload your file to dropbox, you need to replace the start of the default share link it gives you with https://dl.dropboxusercontent.com
        },
        {
