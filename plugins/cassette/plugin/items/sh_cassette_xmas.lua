...
ITEM.key = t_cassette.Register("UU Christmas Collection", { -- Name that the cassette UI will show.
        {
            name = "Jingle Bell Rock",
            length = 130, -- Length of song in seconds.
            url = "https://dl.dropboxusercontent.com/s/sosujrmbppirkbf/Jingle%20Bell%20Rock.mp3?dl=0" -- Upload your file to dropbox, you need to replace the start of the default share link it gives you with https://dl.dropboxusercontent.com
        },
        {
