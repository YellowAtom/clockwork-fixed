...
ITEM.key = t_cassette.Register("Blue Sky", {
	{
		name = "Tommy & Shondells - Crystal Blue Persuasion",
		length = 237,
		url = "https://dl.dropboxusercontent.com/s/cae5u1tgh12n4ic/Breaking%20Bad%20Season%205%20-%20Crystal%20Blue%20Persuasion.mp3?dl=0"
	},
	{
