--[[ Undetermined Gaming Cassette Template
 
Modify the values below to suit your needs
Do not edit anything else, OR YOU MAY BREAK STUFF!!
I gave some examples of how to format the Dropbox links in url =
DO NOT USE QUOTATION MARKS IN THE CODE!! Use ' ' in replace of " "
 
Please double check your code before sending!
]]--
 
local ITEM = Clockwork.item:New();
ITEM.name = "S.Y. Cassette";
ITEM.uniqueID = "simon_cassette";
ITEM.cost = 95; -- Increase to whatever. Not too high, though, please. Try to make it less than 100 tokens.
...
ITEM.key = t_cassette.Register("S.Y.", { -- Name that the cassette UI will show.
        {
            name = "YNW Melly - 772 Love PT.1",
            length = 197, -- Length of song in seconds.
            url = "https://dl.dropboxusercontent.com/s/kltkeamky2lzy4p/772%20Love.mp3?dl=0" -- Upload your file to dropbox, you need to replace the start of the default share link it gives you with https://dl.dropboxusercontent.com
        },
        {
